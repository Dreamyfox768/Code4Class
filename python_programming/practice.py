'''
This program implements a traffic light simulator with a GUI using Tkinter. It includes phases for red, green, yellow, and pedestrian crossing, along with a timer and controls for starting, stopping, and resetting the simulation.
'''
